...
function Navbar() {
    return (
        <header className="header fixed top-1 left-1/2 w-[80%] border-2 border-white flex justify-center transform -translate-x-1/2 backdrop-blur-md rounded-4xl shadow-xl z-10">
